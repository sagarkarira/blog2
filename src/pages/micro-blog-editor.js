...
export const MicroBlogEditor = () => {
  ...
  return (
    <div>
      ...
      <div>
        <h5>Post:</h5>
        <TextareaAutosize minRows={6} type="text" name="content" value={post.content} onChange={handleChange} />
        <h5>Tags: </h5>
        <input type="text" name="tags" value={post.tags} onChange={handleChange} />
        <h5>Key</h5>
        <input type="text" name="key" value={post.key} onChange={handleChange} />
        <br/>
        Submit:
        {
          submitAvail && <input type="submit" value="Submit" onClick={handleSubmit}/>
        }
      </div>
    </div>
  )
